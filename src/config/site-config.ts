...
export function get404GifUrl() {
  return `${getStaticBaseUrl()}/static/uploads/2022-09-12/hoyusqf2d051wy59rhmr26-404.gif`
}
...
export const zoneDemoCards = [
  {
    title: 'APP',
    desc: '扫码下载安装即可体验 App',
    image: `${getStaticBaseUrl()}/static/uploads/2025-11/2e5d10df027b4cf28545b44901f7e8a4-app-code.png`,
  },
  {
    title: 'H5 页面',
    desc: '扫码即可体验 H5 页面',
    image: `${getStaticBaseUrl()}/static/uploads/2025-11/ea68358e78fd433fb5d2123e2cc0763b-h5.png`,
  },
  {
    title: '微信小程序',
    desc: '微信扫码体验小程序',
    image: `${getStaticBaseUrl()}/static/uploads/2025-11/1d6c3ffe42c3498a820965d9a46e0e2b-mini-program-code.jpg`,
  },
  {
    title: '支付宝小程序',
    desc: '支付宝扫码体验小程序',
    image: `${getStaticBaseUrl()}/static/uploads/2025-11/68a238667168490ea59c417e7f438b4b-circle_blue_slogan_50cm.png`,
  },
] as const
