...
<template>
  <view class="h5-web-page px-4 py-8 text-center">
    <text class="block text-lg font-bold">{{ pageTitle }}</text>
    <text class="mt-4 block break-all text-sm text-gray-500">{{ fullUrl }}</text>
    <text class="mt-4 block text-sm text-gray-600">该工具依赖 Web 能力（WebRTC、光影边框、PDF 签名等），请在浏览器打开 blog-home-nuxt 完整版。</text>
